...
> In this template, we use `@sanwel` as a placeholder for package names. As a user, you might want to replace it with your own organization or project name. You can use find-and-replace to change all the instances of `@sanwel` to something like `@my-company` or `@project-name`.
